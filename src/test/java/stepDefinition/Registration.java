...
public class Registration {
	...
	public void User_enters_the_OTP() {
	    ...
	    driver.findElement(By.xpath("/html/body/app-root/div[2]/app-otppage/div[2]/div/div/app-otp/form/div[1]/input")).sendKeys(otp);
		
		driver.findElement(By.xpath("/html/body/app-root/div[2]/app-otppage/div[2]/div/div/app-otp/form/button")).click();
	}
